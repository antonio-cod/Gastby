        ...
        <div className="noticias">
          ...
          <div className="contenedor-arquivo">
            ...
            <img className=" " alt="FOTO"></img>
                ...
                <p>O Twitter afirmou em nota nesta quinta-feira (30) que irá 
            ...
            <img className=" " alt="FOTO"></img>
                ...
                <p>O ministro Alexandre de Moraes, do Supremo Tribunal Federal (STF), 
            ...
            <img className=" " alt="FOTO"></img>
                ...
                <p>1 de 1 Alexandre de Moraes, ministro do STF — Foto: Rosinei Coutinho/SCO/STF O ministro Alexandre de Moraes, do Supremo Tribunal Federal (STF), determino o bloqueio de contas de 16 apoiadores do presidente Jair Bolsonaro em redes sociais também no exterior. Moraes considerou que houve cumprimento parcial da decisão, o que acarreta imposição de multa. Segundo o ministro,
